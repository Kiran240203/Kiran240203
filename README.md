...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&duration=2800&pause=900&center=true&vCenter=true&width=760&lines=Full+Stack+Developer;React.js+%7C+Node.js+%7C+Express.js+%7C+MongoDB;REST+APIs+%7C+JWT+%7C+Redis+%7C+Real-Time+Apps;Building+practical+full-stack+web+applications;Open+to+Japan+Opportunities+%F0%9F%87%AF%F0%9F%87%B5" alt="Animated typing header" />

<img src="https://capsule-render.vercel.app/api?type=waving&height=180&section=header&text=FULL%20STACK%20DEVELOPER&fontSize=38&fontAlignY=40&animation=twinkling" alt="Animated 3D-style header" />
...
- 🏅 Introduction to MongoDB & Vector Search — ICT Academy Learnathon
- 🏅 JavaScript Fundamentals
- 🏅 Entry Level Professional Advancement Program (ELPAP)
- 🏅 Develop Serverless Applications on Cloud Run — Google Skill Badge
